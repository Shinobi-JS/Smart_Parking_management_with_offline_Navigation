...
if($isValidChecksum == "TRUE") {
	...
	if ($_POST["STATUS"] == "TXN_SUCCESS") {
		...
		<script>
			...
			let pl = JSON.parse(localStorage.getItem('temp'))
			let  tempnotes = localStorage.getItem('Parking')
			arr2 = JSON.parse(tempnotes)
			let tobj ={
    		platenum: pl,
			...
			setTimeout(function(){ location.replace('../page.php');; }, 3000);
